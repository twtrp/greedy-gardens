...
class Menu_TutorialState(BaseState):
    ...
    def load_assets(self):
        ...
        for i, surface in enumerate(self.fruit_sprites):
            self.fruit_sprites[i] = utils.effect_outline(surface=surface, distance=2, color=colors.mono_50)
        ...
        for i, surface in enumerate(self.path_sprites):
            ...
            self.path_sprites[i] = utils.effect_outline(surface=self.path_sprites[i], distance=2, color=colors.mono_50)
        ...
        for i, surface in enumerate(self.event_sprites):
            ...
            self.event_sprites[i] = utils.effect_outline(surface=self.event_sprites[i], distance=2, color=colors.mono_50)
        ...
        for i, surface in enumerate(self.magic_fruit_sprites):
            self.magic_fruit_sprites[i] = utils.effect_outline(surface=surface, distance=2, color=colors.mono_50)
