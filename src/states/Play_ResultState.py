...
class Play_ResultStage(BaseState):
    ...
    def load_assets(self):
        ...
        # Check if this is a tutorial - don't save tutorial results
        is_tutorial = self.parent.__class__.__name__ == 'Tutorial_PlayState'
        ...
        if not is_tutorial:
            ...
            # Tutorial mode - don't save, just show current score as high score
            self.high_score = self.parent.total_score
            self.new_record = False
        ...
        if is_tutorial:
            ...
            self.seed_text = utils.get_text(text=f'Set Seed - {self.parent.seed_text}', font=fonts.wacky_pixels, size='smaller', color=colors.white)
        elif not self.setted_seed:
            self.seed_text = utils.get_text(text=f'Random Seed - {self.parent.seed_text}', font=fonts.wacky_pixels, size='smaller', color=colors.white)
